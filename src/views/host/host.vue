...
<script>
  ...
  export default {
    ...
    data() {
      return {
        cellLists1: [
          { link: '', iconUrl: 'http://hzzly.net/xyy-vue/images/user-cert.png', text: '认证', desc: '', badg: '', more: true },
        ...
        cellLists2: [
          ...
          { link: '', iconUrl: 'http://hzzly.net/xyy-vue/images/user-school.png', text: '选择地点', desc: '', badg: '', more: true }
        ],
        cellLists3: [
